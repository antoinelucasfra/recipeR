      ...
      tags$head(
        ...
        tags$style(HTML(
          ...
          * {
          ...
          :root {
            /* New theme: teal primary with warm accent for eye-friendly contrast */
            --primary: #0ea5a4; /* teal-500 */
            --primary-dark: #0b8f87; /* darker teal */
          ...
          /* Compact stat visualizations */
          .stat-spark {
            height: 48px;
            background: linear-gradient(90deg, rgba(14,165,164,0.12), rgba(255,122,89,0.06));
            border-radius: 8px;
            margin-top: 0.5rem;
          }
